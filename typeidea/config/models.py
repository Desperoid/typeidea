...
class Link(models.Model):
    ...
    href = models.URLField(verbose_name='链接')#默认最大长度200
...
class  SideBar(models.Model):
    STATUS_SHOW = 1
    STATUS_HIDE = 0
    STATUS_ITEMS = ((STATUS_SHOW, '显示'), (STATUS_HIDE, '隐藏'))

    DISPLAY_HTML = 1
    DISPLAY_LATEST = 2
    DISPLAY_HOT = 3
    DISPLAY_COMMENT = 4
    SIDE_TYPE = ((DISPLAY_HTML, 'HTML'), (DISPLAY_LATEST, '最新文章'), (DISPLAY_HOT, '最热文章'), (DISPLAY_COMMENT, '最近评论'))
    title = models.CharField(max_length=50, verbose_name='标题')
